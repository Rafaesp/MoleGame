...
public class EntryListItem extends StandardListItem<Void> {
	...
	public EntryListItem(final ComponentActivity context, final Drawable drawable, final String title, final String subTitle) {
	...
	@Override
	public int getType() {
		return Constant.LIST_ITEM_TYPE_ENTRY;
	}
}
