...
public interface ScoreloopManager {
	...
	/**
	 * This method destroys the ScoreloopManager instance.
	 * It should be called when the <a href="http://developer.android.com/reference/android/app/Application.html#onTerminate()">
	 * android.app.Application.onTerminate()</a> method is called from your application class.
	 */
	void destroy();
